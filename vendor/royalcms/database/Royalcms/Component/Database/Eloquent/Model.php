...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     *
     * @param  \Royalcms\Component\Database\Eloquent\ScopeInterface  $scope
     * @return void
     */
     ...
     *
     * @param  \Royalcms\Component\Database\Eloquent\ScopeInterface  $scope
     * @return \Royalcms\Component\Database\Eloquent\ScopeInterface|null
     */
     ...
     * @return $this
     *
     * @throws \Royalcms\Component\Database\Eloquent\MassAssignmentException
     */
     ...
     * @return \Royalcms\Component\Database\Eloquent\Collection|static[]
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Royalcms\Component\Database\Eloquent\Relations\MorphOne
     */
     ...
     * @param  string  $type
     * @param  string  $id
     * @return \Royalcms\Component\Database\Eloquent\Relations\MorphTo
     */
     ...
     * @return \Royalcms\Component\Database\Eloquent\Relations\HasManyThrough
     */
     ...
     * @param  string  $otherKey
     * @param  bool  $inverse
     * @return \Royalcms\Component\Database\Eloquent\Relations\MorphToMany
     */
    ...
    protected function getBelongsToManyCaller()
    {
        ...
        $caller = Arr::first(debug_backtrace(DEBUG_BACKTRACE_IGNORE_ARGS), function ($trace, $key) use ($self) {
     ...
     *
     * @return \Royalcms\Component\DateTime\Carbon
     */
     ...
     * @param  string  $table
     * @param  bool  $exists
     * @return \Royalcms\Component\Database\Eloquent\Relations\Pivot
     */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        if (! $relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                .'Royalcms\Component\Database\Eloquent\Relations\Relation');
        }
     ...
     *
     * @return \Royalcms\Component\Database\ConnectionResolverInterface
     */
